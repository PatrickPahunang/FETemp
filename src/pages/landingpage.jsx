    ...
    <header>
      ...
      <div className="w-screen min-h-screen flex justify-center items-center bg-slate-900 flex-col">
        ...
        <div className='flex flex-col'>
          ...
          <a href='/register'><button className=' py-2 px-4 bg-yellow-50 border-1 border-white transition duration-500 hover:bg-yellow-100 text-black rounded-md shadow-2xl text-lg' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100" >Sign Up</button></a>

  ...
  return (
    ...
    <header>
      ...
      <div className="w-screen min-h-screen flex justify-center items-center bg-slate-900 flex-col">
        ...
        <span data-aos="fade-down" data-aos-duration="700" className=' text-white text-2xl'>Welcome to <br/></span><span  data-aos="fade-down" data-aos-duration="1000"  className='text-5xl text-white '>Company XYZ</span>
